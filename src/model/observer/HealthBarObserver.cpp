...
void HealthBarObserver::update() const {
    if (largeMon->isPlayer()) {
        view->updateHealthBar(*view->getPlayerHealthbar(), *view->getPlayerHpText(), largeMon->getCurrentHpPercent(),
                              to_string(largeMon->getCurrentHp()));
        ...
        view->updateHealthBar(*view->getEnemyHealthbar(), *view->getEnemyHpText(), largeMon->getCurrentHpPercent(),
                              to_string(largeMon->getCurrentHp()));
